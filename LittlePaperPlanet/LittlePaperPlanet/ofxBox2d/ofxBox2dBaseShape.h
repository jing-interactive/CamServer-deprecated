...
public:
	...
	//------------------------------------------------
	virtual void addForce(b2Vec2 pt, b2Vec2 amt) {
		if(body != NULL) {
	...
	//------------------------------------------------
	virtual void addImpulseForce(b2Vec2 pt, b2Vec2 amt) {
		if(body != NULL) {
	...
	//------------------------------------------------
	virtual void addAttractionPoint(b2Vec2 pt, float amt, float minDis=NULL) {
	...
	//------------------------------------------------
	virtual void addRepulsionForce(b2Vec2 pt, float radius, float amt) {
		/*if(body != NULL) {
			b2Vec2 P(pt.x/OFX_BOX2D_SCALE, pt.y/OFX_BOX2D_SCALE);
			b2Vec2 D = P - body->GetPosition(); 
	...
	virtual void addAttractionPoint(float x, float y, float amt, float minDis=NULL) {
		addAttractionPoint(b2Vec2(x, y), amt, minDis);
	}
